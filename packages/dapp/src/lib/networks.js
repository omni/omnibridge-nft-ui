...
const ETH_XDAI_BRIDGE_CONFIG = {
  ...
  foreignBridgeSubgraph: 'dan13ram/mainnet-xdai-GUBridge-nft',
  homeBridgeSubgraph: 'dan13ram/xdai-mainnet-GUBridge-nft',
...
const RINKEBY_XDAI_BRIDGE_CONFIG = {
  ...
  foreignBridgeSubgraph: 'dan13ram/rinkeby-xdai-GUBridge-nft',
  homeBridgeSubgraph: 'dan13ram/xdai-rinkeby-GUBridge-nft',
  home721Subgraph: 'sunguru98/erc721-xdai-subgraph',
...
const KOVAN_SOKOL_BRIDGE_CONFIG = {
  ...
  foreignBridgeSubgraph: 'dan13ram/kovan-sokol-GUBridge-nft',
  homeBridgeSubgraph: 'dan13ram/sokol-kovan-GUBridge-nft',
...
const GUSANDBOX_ROPSTEN_BRIDGE_CONFIG = {
  ...
  homeBridgeSubgraph: 'gulaps/gusandbox-to-ropsten-GUBridge-nft',
...
const GUSANDBOX_RINKEBY_BRIDGE_CONFIG = {
  ...
  homeBridgeSubgraph: 'gulaps/gusandbox-to-rinkeby-GUBridge-nft',
  home721Subgraph: 'gulaps/erc721-subgraph',
  foreign721Subgraph: 'daisai3/eip721_rinkeby',
  home1155Subgraph: 'gulabs/erc1155-subgraph',
  foreign1155Subgraph: 'sunguru98/erc1155-rinkeby-subgraph',
